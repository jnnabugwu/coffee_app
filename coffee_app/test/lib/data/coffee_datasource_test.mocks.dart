...
// in coffee_app/test/lib/data/coffee_datasource_test.dart.
...
class MockDatabaseHelper extends _i1.Mock implements _i8.DatabaseHelper {
  ...
  _i4.Future<_i3.Database> get database => (super.noSuchMethod(
        ...
        returnValue: _i4.Future<_i3.Database>.value(_FakeDatabase_2(
          this,
          Invocation.getter(#database),
        )),
  ...
  @override
  _i4.Future<String> computeImageHash(_i9.File? imageFile) =>
      (super.noSuchMethod(
        Invocation.method(
          #computeImageHash,
          [imageFile],
  ...
  @override
  _i4.Future<bool> isImageDuplicate(String? imageHash) => (super.noSuchMethod(
        Invocation.method(
          #isImageDuplicate,
          [imageHash],
        ),
